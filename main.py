...
def localized(image):
    ...
    cv2.imwrite(r"C:\Users\Aniket Verma\Desktop\BRCODE\img\all barcode\s2.png", cropped)
    crop_res = cv2.imread(r"C:\Users\Aniket Verma\Desktop\BRCODE\img\all barcode\s2.png")
    sr = cv2.dnn_superres.DnnSuperResImpl_create()
    path=r"C:\Users\Aniket Verma\Desktop\BRCODE\ESPCN_x4.pb"
    sr.readModel(path)
    sr.setModel("espcn", 3)
    result_res = sr.upsample(crop_res)
    cv2.imshow("res", result_res)
    cv2.imwrite(r"C:\Users\Aniket Verma\Desktop\BRCODE\img\all barcode\s1_res.png", result_res)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
    result_res2=cv2.imread(r"C:\Users\Aniket Verma\Desktop\BRCODE\img\all barcode\s1_res.png")
    BarcodeReader(result_res2)
#methood to decode bar code
def BarcodeReader():
    # read the image in numpy array using cv2
    img =cv2.imread(r"C:\Users\Aniket Verma\Desktop\BRCODE\img\all barcode\s2.png", cropped)
...
if __name__ == "__main__":
    ...
    image = r"C:\Users\Aniket Verma\Desktop\BRCODE\img\partial barcode\IMG_20220303_174238.jpg"
    getContours(image)
    localized(image)
    BarcodeReader()
